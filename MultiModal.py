...
def multimodal():
    ...
    """
    # 명함 이미지 처리
    image_folder = '/root/LLM_Bootcamp/Project2/card_sample'        # 해당 루트로 변경
    ...
    # 이미 처리된 이미지 목록 읽기
    try:
        with open('/root/LLM_Bootcamp/Project2/name.txt', 'r') as f:
    ...
    for image_file in image_files:
        ...
        print(results)
        with open('/root/LLM_Bootcamp/Project2/name.txt', 'a') as f:
            f.write(image_file + '\n')
